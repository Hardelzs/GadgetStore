...
export default function Topbar({ pageName = "Dashboard" }) {
  ...
  return (
    <header className="px-4 md:px-6 py-4 fixed top-0 left-0 md:left-52 right-0 z-10 backdrop-blur-md bg-white/70">
      <div className="flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <div className="text-[#929DAE] w-full md:w-auto">
          ...
          <h2 className="font-bold text-black text-lg md:text-xl">{pageName}</h2>
        </div>
