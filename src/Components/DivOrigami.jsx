...
export const DivOrigami = () => {
  return (
    <section className="flex h-42 flex-col items-center justify-center gap-12 px-4 py-24 md:flex-row">
      <LogoRolodex
        items={[
...
const LogoRolodex = ({ items }) => {
  ...
  return (
    <div
      ...
      className="relative z-0 h-24 w-28 shrink-0 rounded-xl border border-neutral-700 bg-neutral-800"
    >
...
const LogoItem = ({ children, className }) => {
  return (
    <div
      className={twMerge(
        "grid h-20 w-24 place-content-center rounded-lg bg-neutral-700 text-6xl text-neutral-50",
        className
      )}
    >
      {children}
